...
const CATEGORIES = [
  {
    ...
    tag: 'AI',
    description: 'Get personalized, real-time AI assistance for your learning journey.',
  ...
  },
  {
    ...
    slug: 'live-classes',
    tag: 'Live',
    description: 'Interact with expert instructors in engaging live online classes.',
  ...
  },
  {
    ...
    tag: 'Community',
    description: 'Collaborate and share ideas with a global community of learners.',
  ...
  },
  {
    ...
    tag: 'Mobile',
    description: 'Enjoy a seamless learning experience across all your mobile devices.',

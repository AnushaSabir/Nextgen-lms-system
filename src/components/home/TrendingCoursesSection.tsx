...
const TRENDING = [
  { id: 1, title: 'Web Development', description: 'Build stunning, high-performance websites from scratch. Master HTML, CSS, JavaScript, React, and Next.js with real projects that get you hired.', level: 'All Levels', Icon: Code, students: '2.4k', thumbnail: 'https://images.unsplash.com/photo-1547658719-da2b51169166?w=600&auto=format&fit=crop&q=80' },
  { id: 2, title: 'Python Programming', description: 'From your first line of code to advanced automation and data processing — master Python the way professionals actually use it.', level: 'All Levels', Icon: Terminal, students: '1.8k', thumbnail: 'https://images.unsplash.com/photo-1526379095098-d400fd0bf935?w=600&auto=format&fit=crop&q=80' },
  { id: 3, title: 'Artificial Intelligence', description: 'Dive into Machine Learning, Neural Networks, Prompt Engineering, and Generative AI. Build intelligent systems that solve real-world problems.', level: 'All Levels', Icon: Brain, students: '3.1k', thumbnail: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=600&auto=format&fit=crop&q=80' },
  { id: 4, title: 'Graphic Design', description: 'Create visuals that stop the scroll. Master Canva, Adobe Photoshop, and Illustrator with design principles that work for brands, businesses, and freelancers.', level: 'All Levels', Icon: Palette, students: '900', thumbnail: 'https://images.unsplash.com/photo-1626785774573-4b799315345d?w=600&auto=format&fit=crop&q=80' },
  { id: 5, title: 'Digital Marketing', description: 'Learn what actually drives results — SEO, Social Media Marketing, Facebook & Google Ads, and content strategies used by top brands worldwide.', level: 'All Levels', Icon: TrendingUp, students: '1.2k', thumbnail: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&auto=format&fit=crop&q=80' },
  { id: 6, title: 'Data Science', description: 'Turn raw data into powerful insights. Learn to analyse, visualise, and model data using Python, Pandas, and industry-standard data science tools.', level: 'All Levels', Icon: Database, students: '1.5k', thumbnail: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&auto=format&fit=crop&q=80' },
];
